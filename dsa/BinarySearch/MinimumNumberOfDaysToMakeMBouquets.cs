...
public class MinimumNumberOfDaysToMakeMBouquets
{
    ...
    public static void Solution(int[] bloomDay, int m, int k)
    {
        int minDay = MinDays(bloomDay, m, k);
        System.Console.WriteLine(minDay);
    }
    ...
    private static bool CanBouquetForm(int[] bloomDay, int m, int k, int minDays)
    {
        int count = 0;
